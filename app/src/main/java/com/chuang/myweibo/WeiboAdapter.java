...
public class WeiboAdapter extends RecyclerView.Adapter<ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_ORINGIN_ITEM) {//如果是原创类微博
            ...
            view = LayoutInflater.from(mContext).inflate(R.layout.headsearchview, null);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (holder instanceof OriginViewHolder) {
            ...
            //时间
            Date date = DateUtils.parseDate(mData.get(position).created_at, DateUtils.WeiBo_ITEM_DATE_FORMAT);
            ...
            mImageDatas = mData.get(position).pic_urls;
            ...
            mImageDatas = mData.get(position).retweeted_status.pic_urls;
     ...
     * 原创微博类
     */
    public class OriginViewHolder extends ViewHolder {
        public ImageView profile_img;//头像
        public TextView profile_name;//昵称
        public TextView profile_time;//发微博的时间
        public TextView weiboComeFrom;//微博来源
        public TextView weibo_Content;//微博内容
        public TextView redirect;//转发
        public TextView comment;//评论
        public TextView feedlike;//赞
        public RecyclerView imageList;//图片列表
