package com.chuang.myweibo.home.fragment.home;
...
import com.chuang.myweibo.home.activity.MyRepostActivity;
import com.chuang.myweibo.home.activity.weibodetail.WeiBoDetails;
...
public class MainFragment extends Fragment implements WeiboAdapter.OnItemClickListener, View.OnClickListener {
    ...
    public static FriendshipsAPI mFriendshipsAPI;//用户关系API
...
//        mSsoHandler = new SsoHandler(mActivity, mAuthInfo);
        ...
        mFriendshipsAPI = new FriendshipsAPI(mContext, Constants.APP_KEY, mAccessToken);
...
//                intent.putExtra("UID", Long.parseLong(mDatas.get(position).user.id));
//                startActivity(intent);
//                break;
            //-------转评赞---------------------------------------
            case R.id.click_redirect:
                intent = new Intent(mActivity, MyRepostActivity.class);
