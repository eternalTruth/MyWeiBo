package com.chuang.myweibo.home;
...
//            new ImageSliderViewWithFixedSpeed(mActivity).setDuration(this, 700);
        ...
        timer.schedule(new TimerTask() {
            public void run() {
                mActivity.runOnUiThread(new Runnable() {
                    public void run() {
                        ImageSliderView.this.setCurrentItem(ImageSliderView.this
                                .getCurrentItem() + 1);
                    }
                });
            }
